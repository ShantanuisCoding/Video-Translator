...
iface = gr.Interface(
    ...
    inputs=[gr.File(), gr.Dropdown(["English", "Italian", "Japanese", "Russian", "Spanish", "German", "Portuguese"])],
    outputs=gr.Video(),
    verbose=True,
    title='Video Translator',
    description='A simple application that translates video files.',
    article='<div>Your article here.</div>',
    examples=[
        ['obama.mp4', 'English', 'Spanish'],
